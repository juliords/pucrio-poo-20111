 ...
 * vértices de um grafo. Qualquer mudança nesse conjunto invalida o estado do
...
public interface VerticeDataIterator< V extends Serializable >
{
    /**
     * O iterador retorna para a posição inicial do conjunto de vértices do grafo.
     ...
     * INV - O iterador está em estado válido. 
     */
    V next() throws java.util.NoSuchElementException, java.util.ConcurrentModificationException;
}